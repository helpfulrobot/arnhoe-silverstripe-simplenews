...
class NewsArticle extends DataObject {
	...
	function i18n_singular_name() { return _t("NewsArticle.Singular", $this->stat("singular_name")); }
	private static $plural_name = "News articles";
	function i18n_plural_name() { return _t("NewsArticle.Plural", $this->stat("plural_name")); }
